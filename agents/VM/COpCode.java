...
public class COpCode 
{
    ...
    public CInstruction getIns(String name, ArrayList<CToken> tokens) throws Exception
    {
        ...
        switch (name.toUpperCase())
        {
            ...
            case "INDEXOF" : i=new CINDEXOF(VM, tokens); 
                          break;
                          
            case "LASTCH" : i=new CLASTCH(VM, tokens); 
                          break;
                          
            case "REPLACE" : i=new CREPLACE(VM, tokens); 
                          break;
                          
            case "SPLIT" : i=new CSPLIT(VM, tokens); 
                          break;
                          
            case "STRLEN" : i=new CSTRLEN(VM, tokens); 
                          break;
                          
            case "SUBSTR" : i=new CSUBSTR(VM, tokens); 
                          break;
                          
            case "TRIM" : i=new CTRIM(VM, tokens); 
                          break;
                          
            case "REGEX" : i=new CREGEX(VM, tokens); 
                          break;
                          
            case "REFUND" : i=new CREFUND(VM, tokens); 
                          break;
                          
            case "ATPOS" : i=new CATPOS(VM, tokens); 
                           break;
                         
            case "IF" : i=new CIF(VM, tokens); 
                         break;
                         
            case "STORQUERY" : i=new CSTORQUERY (VM, tokens); 
                               break; 
                         
            case "CONCAT" : i=new CCONCAT(VM, tokens); 
                            break;
                            
            case "TWEET" : i=new CTWEET(VM, tokens); 
                            break;
                            
            case "PUSH" : i=new CPUSH(VM, tokens); 
                          break;
