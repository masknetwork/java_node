...
public class CHTTP extends CInstruction 
{
    ...
    public CHTTP(VM VM, ArrayList<CToken>tokens) 
    {
        ...
        // Par 1
        if (tokens.get(1)!=null) this.par_1=tokens.get(3);
        
        // Par 2
        if (tokens.get(2)!=null) this.par_2=tokens.get(5);
        
        // Par 3
        if (tokens.get(3)!=null) this.par_3=tokens.get(7);
        
        // Par 4
        if (tokens.get(4)!=null) this.par_4=tokens.get(9);
        
        // Par 5
        if (tokens.get(5)!=null) this.par_5=tokens.get(11);
        
        // Par 6
        if (tokens.get(6)!=null) this.par_6=tokens.get(13);
        
        // Par 7
        if (tokens.get(7)!=null) this.par_7=tokens.get(15);
        
        // Par 8
        if (tokens.get(8)!=null) this.par_8=tokens.get(17);
        
        // Par 9
        if (tokens.get(9)!=null) this.par_9=tokens.get(19);
        
        // Par 10
        if (tokens.get(10)!=null) this.par_10=tokens.get(21);
    }  
