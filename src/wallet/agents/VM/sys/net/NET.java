...
public class NET 
{
    ...
    public CCell getField(String field) throws Exception
    {
        ...
        if (!field.equals("LAST_BLOCK") && 
            ...
            !field.equals("ACTUAL_BLOCK") && 
            !field.equals("ACTUAL_BLOCK_HASH") && 
        ...
        switch (field)
        {
            ...
            case "ACTUAL_BLOCK" : res=new CCell(UTILS.NET_STAT.actual_block_no); break;
            case "ACTUAL_BLOCK_HASH" : res=new CCell(UTILS.NET_STAT.actual_block_hash); break;
            case "NET_DIF" : res=new CCell(UTILS.NET_STAT.net_dif.toString()); break;
        }
