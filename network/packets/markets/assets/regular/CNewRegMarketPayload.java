...
{   
    ...
    public CResult check(CBlockPayload block)
    {
         ...
         if (UTILS.BASIC.marketSymbolUsed(mkt_symbol)==true)
            return new CResult(false, "Market symbol is already used", "CNewRegMarketPayload.java", 74);
         ...
         if (this.fee<0.01 || this.fee>10)
            return new CResult(false, "Invalid market fee", "CNewRegMarketPayload.java", 74);
         
         // Market fee address
         if (!UTILS.BASIC.adressValid(this.fee_adr))
              return new CResult(false, "Invalid market fee address", "CNewRegMarketPayload.java", 74);
         
         // Market bid
         if (!UTILS.BASIC.mktBidValid(this.bid))
             return new CResult(false, "Invalid market days", "CNewRegMarketPayload.java", 74);
