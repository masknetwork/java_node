...
public class CNewSpecMarketPacket extends CBroadcastPacket
{
   public CNewSpecMarketPacket(String fee_adr,
                               String mkt_adr, 
			       String feed, 
			       String branch, 
			       String cur, 
			       ...
			       long days) throws Exception
    {
	  ...
	  CNewSpecMarketPayload dec_payload=new CNewSpecMarketPayload(mkt_adr, 
                                                                      feed, 
			                                              branch, 
			                                              cur, 
				                                      max_leverage,
	...
	public void check(CBlockPayload block) throws Exception
	{
	    ...
	    CNewSpecMarketPayload dec_payload=(CNewSpecMarketPayload) UTILS.SERIAL.deserialize(payload);
